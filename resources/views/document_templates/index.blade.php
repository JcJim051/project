            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Usa marcadores en el Word: @verbatim{{OBJETO}}@endverbatim, @verbatim{{ID_PROYECTO}}@endverbatim, @verbatim{{BIPIN}}@endverbatim, @verbatim{{FORMULADOR}}@endverbatim, @verbatim{{FECHA}}@endverbatim. El marcador legado @verbatim{{BPIN}}@endverbatim también se llena con el ID proyecto.
                    </p>
                </div>
