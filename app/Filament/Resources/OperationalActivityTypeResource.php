...
use App\Filament\Resources\OperationalActivityTypeResource\Pages;
...
class OperationalActivityTypeResource extends Resource
{
    protected static ?string $model = OperationalActivityType::class;
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\TextInput::make('icono')->maxLength(100),
            ...
            Forms\Components\Toggle::make('track_as_kpi')->label('Medir como indicador')->default(true),
    ...
    public static function table(Table $table): Table
    {
        return $table->defaultSort('orden')->columns([
            ...
            Tables\Columns\IconColumn::make('track_as_kpi')->label('KPI')->boolean(),
            Tables\Columns\IconColumn::make('activo')->boolean(),
        ])->actions([Tables\Actions\EditAction::make()]);
    }

    public static function getPages(): array { return ['index' => Pages\ListOperationalActivityTypes::route('/'), 'create' => Pages\CreateOperationalActivityType::route('/create'), 'edit' => Pages\EditOperationalActivityType::route('/{record}/edit')]; }
